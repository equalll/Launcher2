...
public class FocusOnlyTabWidget extends TabWidget {
    ...
    public View getSelectedTab() {
        System.out.println("FocusOnlyTabWidget getSelectedTab");
    ...
    public int getChildTabIndex(View v) {
        System.out.println("FocusOnlyTabWidget getChildTabIndex");
    ...
    public void onFocusChange(android.view.View v, boolean hasFocus) {
        System.out.println("FocusOnlyTabWidget onFocusChange");
