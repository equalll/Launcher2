...
final class Utilities {
    ...
    static Bitmap createIconBitmap(Bitmap icon, Context context) {
        System.out.println("Utilties createIconBitmap");
    ...
    static void drawSelectedAllAppsBitmap(Canvas dest, int destWidth, int destHeight,
        ...
        System.out.println("Utilties drawSelectedAllAppsBitmap");
        synchronized (sCanvas) { // we share the statics :-(
            if (sIconWidth == -1) {
    ...
    static Bitmap resampleIconBitmap(Bitmap bitmap, Context context) {
        System.out.println("Utilties resampleIconBitmap");
        synchronized (sCanvas) { // we share the statics :-(
            if (sIconWidth == -1) {
                initStatics(context);
            }
    ...
    static Bitmap drawDisabledBitmap(Bitmap bitmap, Context context) {
        System.out.println("Utilties drawDisabledBitmap");
        synchronized (sCanvas) { // we share the statics :-(
            if (sIconWidth == -1) {
                initStatics(context);
            }
    ...
    static int roundToPow2(int n) {
        System.out.println("Utilties roundToPow2");
        int orig = n;
        n >>= 1;
        int mask = 0x8000000;
    ...
    static int generateRandomId() {
        System.out.println("Utilties generateRandomId");
