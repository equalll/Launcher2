...
public class SearchDropTargetBar extends FrameLayout implements DragController.DragListener {
    ...
    public void setup(Launcher launcher, DragController dragController) {
        System.out.println("SearchDropTargetBar setChildrenDrawingCacheEnabled");
    ...
    private void prepareStartAnimation(View v) {
        System.out.println("SearchDropTargetBar prepareStartAnimation");
    ...
    private void setupAnimation(ObjectAnimator anim, final View v) {
        System.out.println("SearchDropTargetBar setupAnimation");
    ...
    protected void onFinishInflate() {
        System.out.println("SearchDropTargetBar onFinishInflate");
    ...
    public void finishAnimations() {
        System.out.println("SearchDropTargetBar finishAnimations");
    ...
    public void showSearchBar(boolean animated) {
        System.out.println("SearchDropTargetBar showSearchBar");
    ...
    public void hideSearchBar(boolean animated) {
        System.out.println("SearchDropTargetBar hideSearchBar");
        if (mIsSearchBarHidden) return;
        if (animated) {
            prepareStartAnimation(mQSBSearchBar);
    ...
    public int getTransitionInDuration() {
        System.out.println("SearchDropTargetBar getTransitionInDuration");
        return sTransitionInDuration;
    }
    public int getTransitionOutDuration() {
        System.out.println("SearchDropTargetBar getTransitionOutDuration");
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
        System.out.println("SearchDropTargetBar onDragStart");
    ...
    public void deferOnDragEnd() {
        System.out.println("SearchDropTargetBar deferOnDragEnd");
        mDeferOnDragEnd = true;
    }

    @Override
    public void onDragEnd() {
        System.out.println("SearchDropTargetBar onDragEnd");
        if (!mDeferOnDragEnd) {
    ...
    public void onSearchPackagesChanged(boolean searchVisible, boolean voiceVisible) {
        System.out.println("SearchDropTargetBar onSearchPackagesChanged");
    ...
    public Rect getSearchBarBounds() {
        System.out.println("SearchDropTargetBar getSearchBarBounds");
        if (mQSBSearchBar != null) {
