...
public class FocusHelper {
    ...
    static boolean handleAppsCustomizeTabKeyEvent(View v, int keyCode, KeyEvent e) {
        System.out.println("FocusHelper handleAppsCustomizeTabKeyEvent");
    ...
    private static ViewGroup getAppsCustomizePage(ViewGroup container, int index) {
        System.out.println("FocusHelper getAppsCustomizePage");
    ...
    static boolean handleAppsCustomizeKeyEvent(View v, int keyCode, KeyEvent e) {
        System.out.println("FocusHelper handleAppsCustomizeKeyEvent");
    ...
    static boolean handleTabKeyEvent(AccessibleTabView v, int keyCode, KeyEvent e) {
        System.out.println("FocusHelper handleTabKeyEvent");
    ...
    static boolean handleHotseatButtonKeyEvent(View v, int keyCode, KeyEvent e, int orientation) {
        System.out.println("FocusHelper handleHotseatButtonKeyEvent");
    ...
    private static ShortcutAndWidgetContainer getCellLayoutChildrenForIndex(
        ...
        System.out.println("FocusHelper getCellLayoutChildrenForIndex");
    ...
    private static ArrayList<View> getCellLayoutChildrenSortedSpatially(CellLayout layout,
            ViewGroup parent) {
        System.out.println("FocusHelper getCellLayoutChildrenSortedSpatially");
    ...
    private static View findIndexOfIcon(ArrayList<View> views, int i, int delta) {
        System.out.println("FocusHelper findIndexOfIcon");
    ...
    private static View getIconInDirection(CellLayout layout, ViewGroup parent, int i,
            int delta) {
        System.out.println("FocusHelper getIconInDirection");
    ...
    private static View getClosestIconOnLine(CellLayout layout, ViewGroup parent, View v,
            int lineDelta) {
        System.out.println("FocusHelper getClosestIconOnLine");
        final ArrayList<View> views = getCellLayoutChildrenSortedSpatially(layout, parent);
    ...
    static boolean handleIconKeyEvent(View v, int keyCode, KeyEvent e) {
        System.out.println("FocusHelper handleIconKeyEvent");
    ...
    static boolean handleFolderKeyEvent(View v, int keyCode, KeyEvent e) {
        System.out.println("FocusHelper handleFolderKeyEvent");
        ShortcutAndWidgetContainer parent = (ShortcutAndWidgetContainer) v.getParent();
        final CellLayout layout = (CellLayout) parent.getParent();
