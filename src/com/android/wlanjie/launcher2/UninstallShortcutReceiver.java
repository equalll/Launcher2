...
public class UninstallShortcutReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent data) {
        System.out.println("UninstallShortcutReceiver onReceive");
    ...
    static void enableUninstallQueue() {
        System.out.println("UninstallShortcutReceiver enableUninstallQueue");
        mUseUninstallQueue = true;
    }

    static void disableAndFlushUninstallQueue(Context context) {
        System.out.println("UninstallShortcutReceiver disableAndFlushUninstallQueue");
    ...
    private static void processUninstallShortcut(Context context,
        ...
        System.out.println("UninstallShortcutReceiver processUninstallShortcute");
    ...
    private static void removeShortcut(Context context, Intent data,
        ...
        System.out.println("UninstallShortcutReceiver removeShortcut");
