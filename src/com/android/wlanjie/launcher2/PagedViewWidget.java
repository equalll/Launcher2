...
public class PagedViewWidget extends LinearLayout {
    ...
    protected void onFinishInflate() {
        System.out.println("PgedViewWidget onFinishInflate");
    ...
    public static void setDeletePreviewsWhenDetachedFromWindow(boolean value) {
        System.out.println("PgedViewWidget setDeletePreviewsWhenDetachedFromWindow");
        sDeletePreviewsWhenDetachedFromWindow = value;
    }

    public static void setRecyclePreviewsWhenDetachedFromWindow(boolean value) {
        System.out.println("PgedViewWidget setRecyclePreviewsWhenDetachedFromWindow");
        sRecyclePreviewsWhenDetachedFromWindow = value;
    }

    @Override
    protected void onDetachedFromWindow() {
        System.out.println("PgedViewWidget onDetachedFromWindow");
    ...
    public void applyFromAppWidgetProviderInfo(AppWidgetProviderInfo info,
        ...
        System.out.println("PgedViewWidget applyFromAppWidgetProviderInfo");
        mIsAppWidget = true;
        mInfo = info;
        final ImageView image = (ImageView) findViewById(R.id.widget_preview);
        if (maxWidth > -1) {
    ...
    public void applyFromResolveInfo(
        ...
        System.out.println("PgedViewWidget applyFromResolveInfo");
        mIsAppWidget = false;
        mInfo = info;
    ...
    public int[] getPreviewSize() {
        System.out.println("PgedViewWidget getPreviewSize");
    ...
    void applyPreview(FastBitmapDrawable preview, int index) {
        System.out.println("PgedViewWidget applyPreview");
    ...
    void setShortPressListener(ShortPressListener listener) {
        System.out.println("PgedViewWidget setShortPressListener");
    ...
    class CheckForShortPress implements Runnable {
        public void run() {
            System.out.println("PgedViewWidget run");
    ...
    private void checkForShortPress() {
        System.out.println("PgedViewWidget checkForShortPress");
        if (sShortpressTarget != null) return;
    ...
    private void removeShortPressCallback() {
        System.out.println("PgedViewWidget removeShortPressCallback");
        if (mPendingCheckForShortPress != null) {
    ...
    private void cleanUpShortPress() {
        System.out.println("PgedViewWidget cleanUpShortPress");
    ...
    static void resetShortPressTarget() {
        System.out.println("PgedViewWidget resetShortPressTarget");
