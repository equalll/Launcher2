...
public abstract class PagedViewWithDraggableItems extends PagedView
    ...
    protected boolean beginDragging(View v) {
        System.out.println("PagedViewWithDraggableItems beginDragging");
    ...
    protected void cancelDragging() {
        System.out.println("PagedViewWithDraggableItems cancelDragging");
        mIsDragging = false;
    ...
    private void handleTouchEvent(MotionEvent ev) {
        System.out.println("PagedViewWithDraggableItems handleTouchEvent");
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        System.out.println("PagedViewWithDraggableItems onInterceptTouchEvent");
        handleTouchEvent(ev);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        System.out.println("PagedViewWithDraggableItems onTouchEvent");
        handleTouchEvent(ev);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        System.out.println("PagedViewWithDraggableItems onTouch");
        mLastTouchedItem = v;
        mIsDragEnabled = true;
        return false;
    }
    ...
    public boolean onLongClick(View v) {
        System.out.println("PagedViewWithDraggableItems onLongClick");
    ...
    protected void determineScrollingStart(MotionEvent ev) {
        System.out.println("PagedViewWithDraggableItems determineScrollingStart");
    ...
    protected void determineDraggingStart(MotionEvent ev) {
        System.out.println("PagedViewWithDraggableItems determineDraggingStart");
        /*
    ...
    public void setDragSlopeThreshold(float dragSlopeThreshold) {
        System.out.println("PagedViewWithDraggableItems setDragSlopeThreshold");
        mDragSlopeThreshold = dragSlopeThreshold;
    }

    @Override
    protected void onDetachedFromWindow() {
        System.out.println("PagedViewWithDraggableItems onDetachedFromWindow");
        cancelDragging();
    ...
    protected void onPageBeginMoving() {
        System.out.println("PagedViewWithDraggableItems onPageBeginMoving");
        showScrollingIndicator(false);
    }
    protected void onPageEndMoving() {
        System.out.println("PagedViewWithDraggableItems onPageEndMoving");
