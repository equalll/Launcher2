...
public class DrawableStateProxyView extends LinearLayout {
    ...
    public DrawableStateProxyView(Context context, AttributeSet attrs, int defStyle) {
        ...
        System.out.println("DrawableStateProxyView init");
    ...
    protected void drawableStateChanged() {
        System.out.println("DrawableStateProxyView drawableStateChanged");
    ...
    public boolean onHoverEvent(MotionEvent event) {
        System.out.println("DrawableStateProxyView onHoverEvent");
        return false;
    }
}
