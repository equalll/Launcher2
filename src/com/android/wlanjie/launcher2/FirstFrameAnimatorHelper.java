...
public class FirstFrameAnimatorHelper extends AnimatorListenerAdapter
    ...
    public FirstFrameAnimatorHelper(ValueAnimator animator, View target) {
        ...
        System.out.println("FirstFrameAnimatorHelper init");
    }
    ...
    public void onAnimationStart(Animator animation) {
        System.out.println("FirstFrameAnimatorHelper onAnimationStart");
    ...
    public static void initializeDrawListener(View view) {
        System.out.println("FirstFrameAnimatorHelper initializeDrawListenert");
    ...
    public void onAnimationUpdate(final ValueAnimator animation) {
        System.out.println("FirstFrameAnimatorHelper onAnimationUpdatet");
