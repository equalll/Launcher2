...
public class WidgetPreviewLoader {
    ...
    public WidgetPreviewLoader(Launcher launcher) {
        System.out.println("WidgetPreviewLoader init");
    ...
    public void setPreviewSize(int previewWidth, int previewHeight,
        ...
        System.out.println("WidgetPreviewLoader setPreviewSize");
    ...
    public Bitmap getPreview(final Object o) {
        System.out.println("WidgetPreviewLoader getPreview");
    ...
    public void recycleBitmap(Object o, Bitmap bitmapToRecycle) {
        System.out.println("WidgetPreviewLoader recycleBitmapw");
        String name = getObjectName(o);
        synchronized (mLoadedPreviews) {
    ...
    static class CacheDb extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase database) {
            System.out.println("WidgetPreviewLoader onCreatew");
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            System.out.println("WidgetPreviewLoader onUpgrade");
    ...
    private static String getObjectName(Object o) {
        System.out.println("WidgetPreviewLoader getObjectName");
    ...
    private String getObjectPackage(Object o) {
        System.out.println("WidgetPreviewLoader getObjectPackage");
        if (o instanceof AppWidgetProviderInfo) {
    ...
    private void writeToDb(Object o, Bitmap preview) {
        System.out.println("WidgetPreviewLoader writeToDb");
        String name = getObjectName(o);
    ...
    private void clearDb() {
        System.out.println("WidgetPreviewLoader clearDb");
        SQLiteDatabase db = mDb.getWritableDatabase();
        // Delete everything
    ...
    public static void removeFromDb(final CacheDb cacheDb, final String packageName) {
        System.out.println("WidgetPreviewLoader removeFromDb");
        synchronized(sInvalidPackages) {
    ...
    private Bitmap readFromDb(String name, Bitmap b) {
        System.out.println("WidgetPreviewLoader readFromDb");
    ...
    public Bitmap generatePreview(Object info, Bitmap preview) {
        System.out.println("WidgetPreviewLoader generatePreviewb");
        if (preview != null &&
    ...
    public Bitmap generateWidgetPreview(AppWidgetProviderInfo info, Bitmap preview) {
        System.out.println("WidgetPreviewLoader generateWidgetPreviewb");
    ...
    public int maxWidthForWidgetPreview(int spanX) {
        System.out.println("WidgetPreviewLoader maxWidthForWidgetPreview");
    ...
    public int maxHeightForWidgetPreview(int spanY) {
        System.out.println("WidgetPreviewLoader maxHeightForWidgetPreview");
    ...
    public Bitmap generateWidgetPreview(ComponentName provider, int previewImage,
        ...
        System.out.println("WidgetPreviewLoader generateWidgetPreview");
    ...
    private Bitmap generateShortcutPreview(
        ...
        System.out.println("WidgetPreviewLoader generateShortcutPreview");
    ...
    public static void renderDrawableToBitmap(
        ...
        System.out.println("WidgetPreviewLoader renderDrawableToBitmap");
